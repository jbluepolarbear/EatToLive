...
(function() {
  ...
  window.framebuffer = function(width, height, canvasId) {
    ...
    this.makesprite = function(width, height) {
      ...
      // clear sprite fucntion;
      sprite.clear = function(col) {
...
function rgb2hsv(rgb) {
  ...
  */
var Blend = {
  Lerp: function(color1, color2, percent) {
    var invPercent = 1.0 - percent;
    return [color1[0]*invPercent + color2[0]*percent, color1[1]*invPercent + color2[1]*percent, color1[2]*invPercent + color2[2]*percent];
  },
